...
@OnlyIn(Dist.CLIENT)
public class NightshadesSkinRenderer extends PlayerRenderer implements NightshadesIgnoreCancel {
    private final ResourceLocation PLAYER_SKIN;

    public NightshadesSkinRenderer(EntityRendererProvider.Context context, boolean useSmallArms, ResourceLocation skin) {
